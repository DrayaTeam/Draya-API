...
{
    /// <inheritdoc />
    public partial class RefactorToAspNetCoreIdentity : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DropForeignKey(
                name: "FK_PlatformAdmins_AppUsers_UserId",
            ...
            migrationBuilder.DropForeignKey(
                name: "FK_Teachers_AppUsers_UserId",
                table: "Teachers");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_AppUser_Role", "[Role] IN ('Teacher', 'Student', 'SuperAdmin')");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "UQ_PasswordResetToken_TokenHash",
                table: "PasswordResetTokens",
                column: "TokenHash",
                unique: true);
